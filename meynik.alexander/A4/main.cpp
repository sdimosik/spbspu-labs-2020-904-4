...
int main()
{
  try
  {
    ...
    std::cout << "First composite shape after moving in point(2.0, -1.0):\n";
    compShape1.printInfo(std::cout);
    compShape1.move(-2.0, -1.0);
    std::cout << "First composite shape after moving by -2.0(x) and -1.0(y):\n";
    compShape1.printInfo(std::cout);
    ...
    compShape2.move({ 0.0,0.0 });
    std::cout << "Second composite shape after moving to point(0,0):\n";
    compShape2.printInfo(std::cout);
    compShape2.rotate(180.0);
    std::cout << "Second composite shape after rotating by 180 degrees:\n";
    compShape2.printInfo(std::cout);
    compShape2.rotate(180.0);
    std::cout << "Second composite shape after rotating by 180 degrees:\n";
    compShape2.printInfo(std::cout);
    std::cout << "Second composite shape matrix form:\n";
    compShape2.getMatrix().printInfo(std::cout);

    meynik::Matrix matrix;
    std::shared_ptr<meynik::Shape> circle = std::make_shared<meynik::Circle>(meynik::Circle({ -10, 0 }, 2.28));
    std::shared_ptr<meynik::Shape> circle2 = std::make_shared<meynik::Circle>(meynik::Circle({ -10, -10 }, 3));
    std::shared_ptr<meynik::Shape> circle3 = std::make_shared<meynik::Circle>(meynik::Circle({ 10, -10 }, 3));
    std::shared_ptr<meynik::Shape> rectangle = std::make_shared<meynik::Rectangle>(meynik::Rectangle({ 10, 0 }, 5, 4));
    std::shared_ptr<meynik::Shape> rectangle1 = std::make_shared<meynik::Rectangle>(meynik::Rectangle({ -10, 0 }, 2, 3));
    ...
    matrix.addShape(circle);
    matrix.addShape(rectangle);
    std::cout << "Matrix initialized by 4 rectangles and 6 circles\n";
    matrix.printInfo(std::cout);
    meynik::Matrix matrix2(matrix);
    std::cout << "Matrix copied form first matrix\n";
    matrix2.printInfo(std::cout);
    std::cout << "Element with indexes 1 and 1\n";
    matrix[1][1]->printInfo(std::cout);

...
int main() {
  try {
    ...
    std::cout << " 4  Matrix test \n" ;

    bulanov::Matrix matrix;
    bulanov::Circle circle3(5.2, {1.1, 1.1});
    bulanov::Rectangle rectangle3({0.5, 0.5}, 4.1, 5.7);
    bulanov::Rectangle rectangle4({0.6, 0.4}, 3.1, 8.7);
    bulanov::Circle circle4(6.2, {22.1, 22.1});
    bulanov::Circle circle5(0.2, {21.1, 21.1});

    bulanov::Matrix::shapePtr matrixShape1 = std::make_shared<bulanov::Circle>(circle3);
    bulanov::Matrix::shapePtr matrixShape2 = std::make_shared<bulanov::Rectangle>(rectangle3);
    bulanov::Matrix::shapePtr matrixShape3 = std::make_shared<bulanov::Rectangle>(rectangle4);
    bulanov::Matrix::shapePtr matrixShape4 = std::make_shared<bulanov::Circle>(circle4);
    bulanov::Matrix::shapePtr matrixShape5 = std::make_shared<bulanov::Circle>(circle5);

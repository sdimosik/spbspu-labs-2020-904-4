...
void compositeShapeGetFrameRectTest()
{
  ...
  assert(checkClose(compositeShape.getFrameRect().height,
      (circle_frame.pos.y + circle_frame.height / 2) - (triangle_frame.pos.y - triangle_frame.height / 2), ACCURACY));
  assert(checkClose(compositeShape.getFrameRect().width,
      (circle_frame.pos.x + circle_frame.width / 2) - (triangle_frame.pos.x - triangle_frame.width / 2), ACCURACY));
  ...
  assert(checkClose(compositeShape.getFrameRect().pos.y,
      (triangle_frame.pos.y - triangle_frame.height / 2) + (compositeShape.getFrameRect().height / 2), ACCURACY));
}

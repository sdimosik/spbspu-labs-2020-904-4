...
{
  starikevich::CompositeShape shapes;
  starikevich::Triangle triangle({ 3.0, 4.0 }, { 0.0, 4.0 }, { 3.0, 0.0 });
  starikevich::Rectangle rect({ 3.0, 1.0 }, 2.0, 2.0);
  starikevich::Circle circle({ 1.0, 4.0 }, 0.5);
  std::shared_ptr<starikevich::Shape> rect1 = std::make_shared<starikevich::Rectangle>(rect);
  std::shared_ptr<starikevich::Shape> circle1 = std::make_shared<starikevich::Circle>(circle);
  std::shared_ptr<starikevich::Shape> triangle1 = std::make_shared<starikevich::Triangle>(triangle);
...
{
  starikevich::CompositeShape shapes;
  std::shared_ptr<starikevich::Shape> ptr = nullptr;
...
BOOST_AUTO_TEST_CASE(test_get_full_size_composite_shape)
{
  ...
  starikevich::CompositeShape shapes(fullSize);
...
BOOST_AUTO_TEST_CASE(test_get_frame_rect_composite_shape)
{
  ...
  starikevich::Rectangle rect({ 4.0, 2.0 }, 2, 2);
  starikevich::Circle circle({ 1.0, 4.0 }, 1);
  std::shared_ptr<starikevich::Shape> rect1 = std::make_shared<starikevich::Rectangle>(rect);
  std::shared_ptr<starikevich::Shape> circle1 = std::make_shared<starikevich::Circle>(circle);
  std::shared_ptr<starikevich::Shape> triangle1 = std::make_shared<starikevich::Triangle>(triangle);
  shapes.addShape(rect1);
...
BOOST_AUTO_TEST_CASE(test_move_composite_shape)
{
  ...
  BOOST_CHECK_CLOSE(shapes.getFrameRect().width, width, PERMISSIBLE_ACCURACY);
  BOOST_CHECK_CLOSE(shapes.getFrameRect().height, height, PERMISSIBLE_ACCURACY);
  starikevich::point_t point{ 3.4, 3.4 };
  shapes.move(point);
...
BOOST_AUTO_TEST_CASE(test_scale_composite_shape)
{
  starikevich::CompositeShape shapes;
  starikevich::Triangle triangle({ 4.0, 0.0 }, { 0.0, 0.0 }, { 0.0, 3.0 });
  starikevich::Rectangle rect({ 3, 1 }, 2, 2);
  starikevich::Circle circle({ 1, 4 }, 0.5);
  std::shared_ptr<starikevich::Shape> rect1 = std::make_shared<starikevich::Rectangle>(rect);
  std::shared_ptr<starikevich::Shape> circle1 = std::make_shared<starikevich::Circle>(circle);
  std::shared_ptr<starikevich::Shape> triangle1 = std::make_shared<starikevich::Triangle>(triangle);
  shapes.addShape(rect1);
...
BOOST_AUTO_TEST_CASE(test_copy_composite_shape)
{
  ...
  std::shared_ptr<starikevich::Shape> triangle1 = std::make_shared<starikevich::Triangle>(triangle);
  shapes.addShape(triangle1);
  starikevich::CompositeShape shapes1 = shapes;
...
BOOST_AUTO_TEST_CASE(test_semantics_move_composite_shape)
{
  ...
  starikevich::CompositeShape shapes1(std::move(shapes));

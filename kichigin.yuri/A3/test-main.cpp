...
int main()
{
  ...
  testArray[11] = doesCompositeShapeAddShapeWorkCorrectWithUncorrectParameters;
  testArray[12] = doesCompositeShapeDeleteShapeWorkCorrectWithUncorrectParameters;
  testArray[13] = doesCompositeShapeOperatorIndexWorkCorrectWithUncorrectParameters;
  testArray[14] = areCompositeShapeParametersConstantAfterMove;
  testArray[15] = isCompositeShapeAreaChangedSquaredAfrerScale;
